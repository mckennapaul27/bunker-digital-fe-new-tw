...
export const metadata: Metadata = {
  title: "BunkerDigital - Web Design & Digital Marketing Agency",
  description:
    "BunkerDigital is a web design and digital marketing agency that helps businesses grow their online presence.",
};
